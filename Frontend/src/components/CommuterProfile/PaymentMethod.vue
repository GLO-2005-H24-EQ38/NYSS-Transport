...
import {addPaymentMethod, deletePaymentMethod} from "@/api/payment.js";
  ...
  <div>
    ...
    <div class="PaymentMethod"
      ...
      <div style="display: flex; align-items: start; flex-direction: column">
        ...
        <div style="display:flex; justify-content:flex-start; align-items: center; font-weight: bold">Exp. Date: 12/24
        </div>
      </div>
